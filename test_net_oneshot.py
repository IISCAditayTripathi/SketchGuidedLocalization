...
if __name__ == '__main__':
  ...
  if args.dataset == "pascal_voc":
      ...
      # args.imdbval_name = "voc_2007_trainval+voc_2012_trainval"
      args.imdbval_name = "voc_2007_test"
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
  ...
  # print(len(imdb_vu))
  # roidb_vu = roidb_vu[0:1500]
  imdb_vu.competition_mode(on=True)
  class_to_coco_cat_id = imdb_vu._class_to_coco_cat_id
  coco_class_ind_to_cat_id = imdb_vu.coco_class_ind_to_cat_id
  dataset_vu = roibatchLoader(roidb_vu, ratio_list_vu, ratio_index_vu, query_vu, 1, imdb_vu.num_classes,args.sketch_path, args.sketch_class_2_label, class_to_coco_cat_id, coco_class_ind_to_cat_id, training=False, seen=args.seen)
  ...
  output_dir_vu = get_output_dir(imdb_vu, 'faster_rcnn_sketch_oneshot_nn_gated_bmm_max_pool_attention_concat_att_incremental_full_model_pyramid_attention_4_levels_addative_fusion_1_13_12370_full')
