...
__sets = {}
from datasets.pascal_voc_sketch_v2 import pascal_voc
from datasets.coco import coco_sketch
...
for year in ['2014']:
  for split in ['train', 'val', 'minival', 'valminusminival', 'trainval']:
    ...
    __sets[name] = (lambda split=split, year=year: coco_sketch(split, year))
